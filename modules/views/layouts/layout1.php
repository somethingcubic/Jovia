...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">Joviainc - 后台管理</a>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['product/list']) ?>">产品列表</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['product/add']) ?>">添加新产品</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    ...
                    <li><a href="<?php echo yii\helpers\Url::to(['category/add']) ?>">添加新分类</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['variant/list']) ?>">属性列表</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['variant/add']) ?>">添加新属性</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
